...
arc_solutions_file = './input/arc-prize-2025/arc-agi_training_solutions.json'
...
# models
base_model, MyFormatter, perm_aug, max_seq_length_train, mask_first = './input/wb55l_nemomini_fulleval/transformers/default/1', ArcFormatter_premix_3, 'rnd_all', 4224, 0
